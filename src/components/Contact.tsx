...
function MapPinIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" strokeWidth="1.2" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
...
export default function Contact() {
  return (
    <section id="contact" className="relative bg-cream py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-5">
            <div className="group flex items-start gap-4 rounded-2xl bg-white p-6 border border-rose-gold/8 transition-all duration-300 hover:border-rose-gold/15 hover:shadow-md hover:-translate-y-1">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-rose-gold/15">
                <MapPinIcon className="h-5 w-5 text-rose-gold" />
              </div>
              <div>
                <h3 className="mb-1 font-heading text-xl font-semibold text-charcoal">
                  Our Location
                </h3>
                ...
                <a
                  ...
                  className="mt-2 inline-flex items-center gap-1 text-sm font-medium text-rose-gold hover:text-rose-gold-dark transition-colors"
                >
                  Get Directions
            ...
            <div className="group flex items-start gap-4 rounded-2xl bg-white p-6 border border-rose-gold/8 transition-all duration-300 hover:border-rose-gold/15 hover:shadow-md hover:-translate-y-1">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-rose-gold/15">
                <PhoneIcon className="h-5 w-5 text-rose-gold" />
              </div>
              <div>
                <h3 className="mb-1 font-heading text-xl font-semibold text-charcoal">
                  Phone
              ...
              <div>
                ...
                <div className="space-y-2 mt-2">
                  {CONTACT_INFO.hours.map((h) => (
                    ...
                    >
                      <span className="font-medium text-medium-gray">{h.days}</span>
                      <span
                        className={
                          h.time === "Closed"
                            ? "font-medium text-rose-gold"
                            : "text-medium-gray"
                        }
                      >
                        {h.time}
          ...
          {/* Map */}
          <div className="overflow-hidden rounded-2xl border border-rose-gold/10">
            <iframe
